        ...
        <div className={style.Main} id={"App"}>
            <div className={style.Up}>
                <div className={style.MainChose} ref={ref}>
                    ...
                    </div>
                    {
                        ...
                        <div className={style.TypesList}>
                            ...
                            <div className={style.Type} onClick={() => { setShowTypes(false)}}>Предметы</div>
                ...
                <div className={style.Slk}>
                    ...
                    <a onMouseOver={()=>{setShowMyOpis([false,true,false])}} onMouseOut={()=>{setShowMyOpis([false,false,false])}} target="_blank" href="https://github.com/HidasMato/role_cards_items"><GH className={style.Icon2}/></a>
